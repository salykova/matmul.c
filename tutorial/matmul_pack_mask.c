// clang-17 -O2 -mno-avx512f -march=native -DTEST -DNITER=1000 matmul_pack_mask.c -o matmul_pack_mask.out &&
// ./matmul_pack_mask.out
...
void kernel_16x6(float* blockA_packed, float* blockB_packed, float* C, const int m, const int n, const int M,
